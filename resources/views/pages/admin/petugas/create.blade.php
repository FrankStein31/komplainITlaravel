      ...
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <label class="block text-sm">
          ...
          <input
            ...
            type="text" placeholder="2131730071" value="{{ old('nik')}}" name="nik" required></input>
        </label>
        ...
        <label class="block mt-4 text-sm">
          ...
          <input
            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            type="text" placeholder="Frankie Steinlie" value="{{ old('name')}}" name="name" required></input>
        </label>
        ...
        <label class="block text-sm">
          <span class="text-green-700 dark:text-gray-400">Bidang</span>
          <select name="bidang" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" required>
